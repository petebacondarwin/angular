...
export interface BuildMarker {
  ...
  markAsProcessed(
      ...
      formatProperties: PackageJsonFormatProperties[]): void;
}


export class InlineBuildMarker implements BuildMarker {
  constructor(private pkgJsonUpdater: PackageJsonUpdater) {}
  /**
   ...
   * The format is defined by the provided property name of the path to the bundle in the
   * package.json
   *
  ...
  /**
   * Write a build marker for the given entry-point and format properties, to indicate that they
   * have
