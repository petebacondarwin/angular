...
import {
  Injector, Class, Component, Directive, ElementRef, Input, NO_ERRORS_SCHEMA, Output, OnChanges,
  OnDestroy, SimpleChanges, EventEmitter, NgModule, NgModuleRef, OpaqueToken, Testability,
